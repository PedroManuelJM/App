...
// CLASE PARA GUARDAR INFORMACIÓN DE MANERA LOCAL (SOLO EN EL DISPOSITIVO)
public class InternaDB extends SQLiteOpenHelper {
    ...
    private static final String s_crear_tabla_usuario="CREATE TABLE IF NOT EXISTS USUARIO (CORREO VARCHAR(100), CLAVE VARCHAR(128));";
    ...
    @Override
    public void onCreate(SQLiteDatabase db) { //CRUD
        db.execSQL(s_crear_tabla_usuario); //inicializa la tabla
